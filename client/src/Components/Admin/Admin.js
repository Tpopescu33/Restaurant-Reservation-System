          ...
          <div class="col-15-display">
            <div id="name-search">
              <div class="panel-body">
                ...
                <button type="submit" onClick={searchByName}>
                  Search
                </button>
              </div>
            </div>
            ...
            <div id="time-search">
              <div class="panel-body">
                ...
                <button type="submit" onClick={searchByTime}>
                  Search
                </button>
              </div>
            </div>
              ...
              <tbody>
                {reservations.map((reservation) => (
                  <tr key={reservation.orderID}>
                    ...
                    <td>
                      {reservation.resDate} at {reservation.resTime}
                    </td>
                    <td>{reservation.table}</td>
                    <td>
                      <button
                        type="button"
                        onClick={() => cancelReservation(reservation.orderID)}
                      >
                        x
                      </button>
                    </td>
